        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link href="/insecure/forgot-password" className="text-sm text-primary hover:underline">
                  Forgot password?
                </Link>
              </div>
              <Input
          ...
          <CardFooter className="flex flex-col space-y-4">
            ...
            <div className="text-center text-sm">
              ...
              <Link href="/insecure/register" className="text-primary hover:underline">
                Register
              </Link>
            </div>
            <div className="text-center text-sm">
              <Link href="/secure/login" className="text-green-500 hover:underline flex items-center justify-center">
